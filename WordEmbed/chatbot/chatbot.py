...
pairs[0]
# ['there .', 'where ?']
batch2TrainData(voc, [pairs[0]])[0]
# tensor([[3],
#        [4],
#        [2]])
# EOS_token = 2
batch2TrainData(voc, [pairs[0]])[2]
# tensor([[5],
#        [6],
#        [2]])
batch2TrainData(voc, [pairs[0]])[3]
# tensor([[1],
#        [1],
#        [1]])

p=[pairs[0],pairs[1]] 
batch2TrainData(voc, p)[0].size()
batch2TrainData(voc, p)[2].size()
batch2TrainData(voc, p)[3]
